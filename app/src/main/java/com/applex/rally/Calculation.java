...
public class Calculation extends AppCompatActivity implements ActionBar.OnNavigationListener {
    ...
    /* renamed from: go */
    private ImageButton f653go;
    private TextView gpsodo;
    /* renamed from: hh */
    private TextView f654hh;
    /* renamed from: mm */
    private TextView f657mm;
    private TextView nextspeed;
    private View.OnClickListener onClickListener;
    private TextView rbodo;
    /* renamed from: ss */
    private TextView f658ss;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        try {
            ...
            this.edit.commit();
            getSupportActionBar().setSubtitle((CharSequence) "Get Ideal Time for any Odo");
            ...
            if (this.loginpref.getInt("distancePreference", -1) == 1) {
                this.enterSpeedZone.setHint("Enter Odo in Miles");
            }
    ...
    private void findViews() {
        this.f653go = (ImageButton) findViewById(R.id.go);
        this.f654hh = (TextView) findViewById(R.id.hh_tv);
        this.f657mm = (TextView) findViewById(R.id.mm_tv);
        this.f658ss = (TextView) findViewById(R.id.ss_tv);
    ...
    private void setListeners() {
        try {
            ...
            this.f653go.setOnClickListener(this.onClickListener);
        } catch (NullPointerException e) {
            e.printStackTrace();
        } catch (Exception e2) {
            e2.printStackTrace();
    ...
    public void calculate() {
        ...
        this.rbo = Float.valueOf(this.enterSpeedZone.getText().toString()).floatValue();
        int j = 0;
            ...
            if (this.loginpref.getFloat("zoneDistanceValue" + String.valueOf(i3 - 1), 0.0f) < this.rbo && this.loginpref.getFloat("zoneDistanceValue" + String.valueOf(i3), 0.0f) >= this.rbo) {
                ...
                for (int l = 1; l < k + 1; l++) {
                    if (this.loginpref.getFloat("tcDistanceValue" + String.valueOf(l), 0.0f) <= this.rbo && this.loginpref.getFloat("zoneDistanceValue" + String.valueOf(i3 - 1), 0.0f) <= this.loginpref.getFloat("tcDistanceValue" + String.valueOf(l), 0.0f)) {
                        ...
                        this.edit.commit();
                        Log.d("hackTSD", "Enter Speed Chart: hard point h time : " + this.loginpref.getInt("tchho" + String.valueOf(l), 0));
                        Log.d("hackTSD", "Enter Speed Chart: hard point m time : " + this.loginpref.getInt("tcmmo" + String.valueOf(l), 0));
                        Log.d("hackTSD", "Enter Speed Chart: hard point s time : " + this.loginpref.getInt("tcsso" + String.valueOf(l), 0));
                    }
                }
        ...
        if (Float.valueOf(this.rbo - this.loginpref.getFloat("hardPointz", 0.0f)).floatValue() >= Float.valueOf(this.rbo - this.loginpref.getFloat("hardPointtc", 0.0f)).floatValue()) {
            ...
            this.edit.commit();
            Log.d("hackTSD", "Enter Speed Chart: hard point : zone");
            Log.d("hackTSD", "Enter Speed Chart: hz : " + hz);
            Log.d("hackTSD", "Enter Speed Chart: mz : " + mz);
            Log.d("hackTSD", "Enter Speed Chart: sz : " + sz);
        } else {
            ...
            this.edit.commit();
            Log.d("hackTSD", "Enter Speed Chart: hard point : zone");
            Log.d("hackTSD", "Enter Speed Chart: hz : " + ht);
            Log.d("hackTSD", "Enter Speed Chart: mz : " + mt);
            Log.d("hackTSD", "Enter Speed Chart: sz : " + st);
        }
        ...
        Log.d("hackTSD", "Enter Speed Chart:  : " + del);
        ...
        this.f654hh.setText(String.valueOf(houra));
        this.f657mm.setText(String.valueOf(minutea));
        this.f658ss.setText(String.valueOf(seconda));
